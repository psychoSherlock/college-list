const Course = ({ courseData }) => {
  return (
    <div
      className="bg-[#003366] text-[whitesmoke] w-[400px] p-5 rounded-lg hover:scale-105 transition-all ease-in-out duration-300 cursor-pointer"
    ...
    >
      <div className="border-2 borde-white rounded-lg p-5 h-full flex flex-col gap-2 justify-evenly">
        ...
        <h2 className="text-2xl font-bold ">
          Fees: {courseData.perYearFeeAUD} AUD per year
        </h2>
      </div>
    </div>
  );
